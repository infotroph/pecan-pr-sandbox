##' Get format entries with no input records
##'
##' This is a function that returns a dataframe with all of the format entries
##'   that have no associated input records.
##'
##' For more information on how to use this function see the
##' "Pre-release-database-cleanup" script in the 'vignettes' folder
