...
plot.da <- function(prior.dir, prior.file, in.dir, out.dir, next.run.dir) {
  ...
  da.traits.hite <- list(
    tundra.grass = c("plant_min_temp", "hgt_min", "seed_rain"),
  ...
  da.traits <- list(
    tundra.grass = c("seedling_mortality", "f_labile", "root_turnover_rate", "Vcmax", "leaf_width"),
  ...
  # MOST SENSITIVE, BY NEE
  da.traits.shared <- list(
    tundra.grass = c(
      "root_turnover_rate", "seed_rain", "hgt_min", "seedling_mortality",
